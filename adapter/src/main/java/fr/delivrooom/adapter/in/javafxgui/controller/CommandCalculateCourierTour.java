...
public class CommandCalculateCourierTour implements Command {
    ...
    private TourSolution previousTourSolution = null;
    ...
    @Override
    public void execute() {
        previousTourSolution = courier.getTourSolution();
        controller.doCalculateTourForCourier(courier);
    }

    @Override
    public void undo() {
        courier.setTourSolution(previousTourSolution);
    ...
    public String getStringReversedDescription() {
        return "Uncalculate tour for courier " + courier.getId();
    }
}
